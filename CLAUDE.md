...
MCP server exposing a curated, static registry of 46 AI models across 7 providers. Built in Go with the official MCP SDK.
...
| `go-server/internal/models/data.go` | `Models` map with all 46 model entries |
